...
new GoTop(__WEBPACK_IMPORTED_MODULE_0_jquery___default.a('body'))
console.log(123)
Carousel.launch(__WEBPACK_IMPORTED_MODULE_0_jquery___default.a('.container'))

render()
function render(){
var i
console.log('render')
var windowWidth = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('.imgs-container').width();
var itemWidth = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('.img-container').outerWidth(true);
var colNum = parseInt(windowWidth/itemWidth)
var colHeights = []
var $items = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('.img-container')
for(i = 0; i < colNum; i++){
	colHeights[i] = 0
}
...
Exposure.prototype.bind = function(){
  var _this = this
  __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('#loadmore').on('click', function(){
...
Exposure.prototype.isShow = function(){
  ...
  var scrollTop = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('.imgs-container').css('height');
...
return {
   launch: function($node,callback){
     $node.each(function(index,element){
        new Exposure(__WEBPACK_IMPORTED_MODULE_0_jquery___default.a(element),callback)
      })
   }
}
})()
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default.a('#loadmore').on('click',function(){
	//console.log(123)
	var height = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('.imgs-container').height()
	__WEBPACK_IMPORTED_MODULE_0_jquery___default.a('.imgs-container').height( height + 250)
	setTimeout(function(){
		_Exposure.launch(__WEBPACK_IMPORTED_MODULE_0_jquery___default.a('.img-container'), function(){
      	this.$node.find('img')
